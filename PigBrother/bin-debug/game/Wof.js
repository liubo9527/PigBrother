...
var Wof = (function (_super) {
    ...
    function Wof(state, gameControl) {
        var _this = _super.call(this) || this;
        _this.walkSpeed = 120;
        _this.flySpeed = 60;
        _this.beKilled = false;
        _this.skinName = "wof";
        _this.wofState = state;
        _this.gameControl = gameControl;
        return _this;
    }
    Object.defineProperty(Wof.prototype, "wofState", {
        //状态机
        //wof WofFSM
        get: function () {
...
__reflect(WofFSM.prototype, "WofFSM");
//攻击
var WofAttack = (function (_super) {
    __extends(WofAttack, _super);
    function WofAttack() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WofAttack.prototype.handle = function (wof) {
    };
    return WofAttack;
}(WofFSM));
__reflect(WofAttack.prototype, "WofAttack");
//行走
var WofWalk = (function (_super) {
    __extends(WofWalk, _super);
    function WofWalk() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WofWalk.prototype.handle = function (wof) {
    };
    return WofWalk;
}(WofFSM));
__reflect(WofWalk.prototype, "WofWalk");
//飞行
var WofFly = (function (_super) {
    __extends(WofFly, _super);
    function WofFly() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WofFly.prototype.handle = function (wof) {
    };
    return WofFly;
}(WofFSM));
__reflect(WofFly.prototype, "WofFly");
